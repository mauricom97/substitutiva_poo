...
public class Checkout {
    ...
    public String toString() {
        ...
        saida += String.format("%-25s %6s\n", "Valor imposto", Sorveteria.centavos2ReaisECentavos(impostoTotal()));
        saida += String.format("%-25s %6s", "Valor custo Total", Sorveteria.centavos2ReaisECentavos(custoTotal()+impostoTotal()));
        return saida;
    }
